const HomePage = () => {
  ...
  return (
    <article className="w-full">
      <div className="bg-hero bg-cover min-h-[300px] py-10 px-12 max-sm:py-6 max-sm:px-6 rounded-3xl flex flex-col justify-between">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-text-2 text-2xl max-sm:text-[1.2rem] font-semibold">{date}</span>
        </div>
      </div>
    </article>
  );
